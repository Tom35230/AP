...
require_once('../backend/gestionnaires.php')
?>
<!DOCTYPE html>
<html lang="fr">
<head>
            ...
            <div class="row mt-5">
                <div class ="col" >
                    <div class ="card mt-5">
                        ...
                        <h2 class ="display-6 text-center">Modifier comptes gestionnaire des animations </h2>
                        </div>
                        <div class="card-body">
                            <table class="table table-bordered text-center">
                                ...
                                <td>
                                    <?php
                                    $sqlQuery = 'SELECT tel, emel FROM administration WHERE STATUT= 2';
                                    ...
                                    foreach ($administration as $admin) {
                                        ?>
                                            ...
                                            <td><a href="modifgestionnaires.php" class="btn btn-primary">Modifier</td>
